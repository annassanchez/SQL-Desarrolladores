...
CREATE UNIQUE NONCLUSTERED INDEX UX_LibraryPublishers_PublisherName ON Library.Publishers
(
	PublisherName
);
--
...
ALTER INDEX UX_LibraryPublishers_PublisherName ON Library.Publishers
...
DROP INDEX Library.Books.IX_LibraryBooks_PublisherID;
--
...
DROP INDEX Library.Books.IX_LibraryBooks_BookDate;
...
ALTER INDEX IX_LibraryBooks_BookDate ON Library.Books REORGANIZE;
--
